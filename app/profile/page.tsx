...
import { Mail, Phone, MapPin, Calendar, Edit, Award, TrendingUp } from "lucide-react"
        ...
        <div className="space-y-6">
          <Card className="overflow-hidden p-0">
            ...
            <div className="relative px-6 pb-6">
              <div className="flex flex-col items-center">
                ...
                <h2 className="mt-4 text-2xl font-bold text-foreground">김철수</h2>
          ...
          <Card className="p-6">
            <div className="mb-4 flex items-center gap-2">
              ...
              <h3 className="text-lg font-semibold text-foreground">활동 통계</h3>
            </div>
            <div className="grid grid-cols-3 gap-4">
              <div className="text-center">
                <div className="text-3xl font-bold text-primary">24</div>
                <p className="mt-1 text-xs text-muted-foreground">예정된 모임</p>
              </div>
              <Separator orientation="vertical" className="mx-auto h-12" />
              <div className="text-center">
                <div className="text-3xl font-bold text-primary">156</div>
                <p className="mt-1 text-xs text-muted-foreground">완료된 모임</p>
              </div>
              <Separator orientation="vertical" className="mx-auto h-12" />
              <div className="text-center">
          ...
          <Card className="p-4">
            <h3 className="mb-4 text-lg font-semibold text-foreground">연락처 정보</h3>
            <div className="space-y-4">
              <div className="flex items-center gap-3 rounded-lg bg-muted/50 p-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="font-medium text-foreground">kim.chulsoo@example.com</p>
                </div>
              </div>
              <div className="flex items-center gap-3 rounded-lg bg-muted/50 p-3">
                <div className="flex h-10 w-10 items-center justify-center rounded-full bg-primary/10">
              ...
              <div className="flex items-center gap-3 rounded-lg bg-muted/50 p-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="font-medium text-foreground">서울, 대한민국</p>
                </div>
              </div>
            </div>
          </Card>
